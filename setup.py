...
setup(name='docassemble.leaseagreementgenerator',
      version='0.0.1',
      ...
      zip_safe=False,
      package_data=find_package_data(where='docassemble/leaseagreementgenerator/', package='docassemble.leaseagreementgenerator'),
     )
